...
def plot_merra_data(data, lons, lats, title='', date='', data_value='', extent=[-150, 150, -90, 90],
                    ...
                    cbar_color = 'YlOrRd', cbar_min = 0, cbar_max = 7, unit = 1):
    ...
    if add_bodele_source_exclusive:
            #right:
            add_pixel(ax,(40*0.5),(39*0.5),(22.9*0.625),(25.8*0.625),alpha=add_bodele_source_exclusive_alpha)
            add_pixel(ax,(39*0.5),(38*0.5),(20.9*0.625),(25.8*0.625),alpha=add_bodele_source_exclusive_alpha)
            add_pixel(ax,(38*0.5),(37*0.5),(20.9*0.625),(29.8*0.625),alpha=add_bodele_source_exclusive_alpha)
            add_pixel(ax,(37*0.5),(36*0.5),(20.9*0.625),(32.8*0.625),alpha=add_bodele_source_exclusive_alpha)
            add_pixel(ax,(36*0.5),(35*0.5),(19.9*0.625),(32.8*0.625),alpha=add_bodele_source_exclusive_alpha)
            add_pixel(ax,(35*0.5),(34*0.5),(18.9*0.625),(32.8*0.625),alpha=add_bodele_source_exclusive_alpha)
            add_pixel(ax,(34*0.5),(33*0.5),(19.9*0.625),(32.8*0.625),alpha=add_bodele_source_exclusive_alpha)
            add_pixel(ax,(33*0.5),(32*0.5),(21.9*0.625),(32.8*0.625),alpha=add_bodele_source_exclusive_alpha)
            add_pixel(ax,(32*0.5),(31*0.5),(21.9*0.625),(32.8*0.625),alpha=add_bodele_source_exclusive_alpha)
            add_pixel(ax,(31*0.5),(30*0.5),(23.9*0.625),(25.8*0.625),alpha=add_bodele_source_exclusive_alpha)
            add_pixel(ax,(31*0.5),(30*0.5),(28.9*0.625),(31.8*0.625),alpha=add_bodele_source_exclusive_alpha)
    ...
    plt.title(f'{title}{date}', size=14, pad=15)
    plt.xlabel('Latitude')
    #colorbar
    if plot_grids:
...
def plot_grid(lats, lons, title='', extent=[-150, 150, -90, 90], borders = False, add_source_region = False):
    ...
    plt.title(f'{title}', size=14, pad=15)
    plt.xlabel('Latitude')
    plt.show()
...
def plot_gpw_data(population_array, lats, lons, extent=[-30,29,-15,29], borders = True, cbar_min = 0, cbar_max = 1000000, unit = 1, population_data =[]):
    ...
    axes[0].title.set_text('Gridded Population of the World Data (year = 2000) Centroids for selected countries')  
        
    for pop_file in population_data:
        for idx, x_coord in enumerate(pop_file['CENTROID_X']):
            axes[0].add_patch(plt.Circle((x_coord, pop_file['CENTROID_Y'][idx]), .1, color='red', alpha = 0.5))
    ...
    axes[1].title.set_text('GPW Data (year = 2000) mapped to MERRA2 Grid')   

    quadmesh2 = axes[1].pcolormesh(lons, lats, population_array, transform=ccrs.PlateCarree(),cmap=cmocean.tools.lighten(cmo.matter, 0.85))
    ...
    cb.set_label('population in millions',size=12,rotation=90,labelpad=15)
...
def plot_ols_data(real_data, predicted_values, y_name= '', x_name = '', title=f'', fig_size=(16,8)):
    ...
    ax.legend(loc="best")
    ax.text(-0.05, 0.55, y_name, va='bottom', ha='center', rotation='vertical', rotation_mode='anchor', transform=ax.transAxes, size=14)
...
def return_region_pixel_array(region_name = ''):
    ...
    # Liberia:
        ...
        liberia_pixels = np.array([[39,35],[39,36],
                                   ...
                                   [42,32],[42,33],[42,34],[42,34],[42,35],
                                   [43,30],[43,31],[43,32],[43,33],[43,34],[43,34],
                                   [44,30],[44,31],[44,32],[44,33],[44,34],[44,34],[44,35],
    ...
    # Mali:
        ...
        mali_pixels = np.array([[51,35],[51,36],[51,37],[51,38],[51,39],
                                ...
                                [59,29],[59,29],[59,30],[59,31],[59,32],[59,33],[59,34],[59,35],[59,36],[59,37],[59,38],[59,39],[59,40],[59,41],[59,42],[59,43],[59,43],[59,44],[59,45],
                                [60,29],[60,29],[60,30],[60,31],[60,32],[60,33],[60,34],[60,35],[60,36],[60,37],[60,38],[60,39],[60,40],[60,41],[60,42],[60,43],[60,43],[60,44],[60,45],[60,46],[60,47],[60,48],[60,49],
                                [61,30],[61,31],[61,32],[61,33],[61,34],[61,35],[61,36],[61,37],[61,38],[61,39],[61,40],[61,41],[61,42],[61,43],[61,43],[61,44],[61,45],[61,46],[61,47],[61,48],[61,49],[61,50],[61,51],[61,52],[61,53],[61,54],
                                [62,40],[62,41],[62,42],[62,43],[62,43],[62,44],[62,45],[62,46],[62,47],[62,48],[62,49],[62,50],[62,51],[62,52],[62,53],[62,54],
                                [63,40],[63,41],[63,42],[63,43],[63,43],[63,44],[63,45],[63,46],[63,47],[63,48],[63,49],[63,50],[63,51],[63,52],[63,53],[63,54],
                                [64,39],[64,40],[64,41],[64,42],[64,43],[64,43],[64,44],[64,45],[64,46],[64,47],[64,48],[64,49],[64,50],[64,51],[64,52],[64,53],[64,54],[64,55],
                                [65,39],[65,40],[65,41],[65,42],[65,43],[65,43],[65,44],[65,45],[65,46],[65,47],[65,48],[65,49],[65,50],[65,51],[65,52],[65,53],[65,54],[65,55],
                                [66,39],[66,40],[66,41],[66,42],[66,43],[66,43],[66,44],[66,45],[66,46],[66,47],[66,48],[66,49],[66,50],[66,51],[66,52],[66,53],[66,54],[66,55],
                                [67,39],[67,40],[67,41],[67,42],[67,43],[67,43],[67,44],[67,45],[67,46],[67,47],[67,48],[67,49],[67,50],[67,51],[67,52],[67,53],[67,54],[67,55],
                                [68,39],[68,40],[68,41],[68,42],[68,43],[68,43],[68,44],[68,45],[68,46],[68,47],[68,48],[68,49],[68,50],[68,51],[68,52],[68,53],[68,54],[68,55],
                                [69,39],[69,40],[69,41],[69,42],[69,43],[69,43],[69,44],[69,45],[69,46],[69,47],[69,48],[69,49],[69,50],[69,51],[69,52],[69,53],
                                [70,39],[70,40],[70,41],[70,42],[70,43],[70,43],[70,44],[70,45],[70,46],[70,47],[70,48],[70,49],[70,50],[70,51],[70,52],[70,53],
                                [71,39],[71,40],[71,41],[71,42],[71,43],[71,43],[71,44],[71,45],[71,46],[71,47],[71,48],[71,49],[71,50],
                                [72,38],[72,39],[72,40],[72,41],[72,42],[72,43],[72,43],[72,44],[72,45],[72,46],[72,47],[72,48],[72,49],[72,50],
                                [73,38],[73,39],[73,40],[73,41],[73,42],[73,43],[73,43],[73,44],[73,45],[73,46],[73,47],[73,48],[73,49],
                                [74,38],[74,39],[74,40],[74,41],[74,42],[74,43],[74,43],[74,44],[74,45],[74,46],[74,47],[74,48],
                                [75,38],[75,39],[75,40],[75,41],[75,42],[75,43],[75,43],[75,44],[75,45],[75,46],
                                [76,38],[76,39],[76,40],[76,41],[76,42],[76,43],[76,43],[76,44],[76,45],
                                [77,38],[77,39],[77,40],[77,41],[77,42],[77,43],[77,43],[77,44],
                                [78,38],[78,39],[78,40],[78,41],[78,42],[78,42],[78,43],
    ...
    # Niger:
        ...
        niger_pixels = np.array([[54,54],
                                 ...
                                 [57,50],[57,51],[57,52],[57,53],[57,54],[57,55],[57,56],[57,57],[57,58],[57,59],[57,60],[57,61],[57,62],[57,63],[57,64],[57,65],[57,66],[57,67],[57,68],[57,69],
...
def create_lag_regression_data(lag_data, lag_num, other_ex_data, y_vector, junsep_indices, novapr_indices, dataframe = True, variable_names = [], y_name = ''):
...
def map_population_to_pixel(population_array, longitudes, latitudes, x_coords, y_coords, pop_values):
    for idx, x_coord in enumerate(x_coords):
        ...
        population_array[y_pixel][x_pixel] += pop_values[idx]
    return population_array

def create_population_array(population_data, longitudes, latitudes):
    population_array = np.zeros((latitudes.shape[0],longitudes.shape[0]))

    for pop_file in population_data:
        population_array = map_population_to_pixel(population_array, longitudes, latitudes, pop_file['CENTROID_X'], pop_file['CENTROID_Y'], pop_file['UN_2000_E'])
